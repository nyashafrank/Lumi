...
describe('Wallet', () => {
    ...
    describe('createTransaction()', () => {
        describe('and the amount exceeds the balance', () => {
            it('throws an error', () => {
                expect( () => wallet.createTransaction({ amount: 9999999, recipient: 'foo-reecipient' }))
        ...
        describe('and there are outputs for the wallet', () => {
            ...
            describe('and the wallet has made a transaction', () => {
                ...
                describe('and there are outputs next to and after the recent transaction', () => {
                    let sameBlockTransacition, nextBlockTransaction;
                    ...
                    beforeEach( () => {
                        ...
                        sameBlockTransacition = Transaction.rewardTransaction({ minerWallet: wallet });

                        blockchain.addBlock({ data: [recentTransaction, sameBlockTransacition] });
                    ...
                    it('includes the output amounts in the returned balance', () => {
                        expect( Wallet.calculateBalance({
                            ...
                            + sameBlockTransacition.outputMap[wallet.publicKey]
